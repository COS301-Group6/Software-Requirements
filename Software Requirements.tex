...
\end{description} 
  ...
  \paragraph{
   An interface with LDAP will be used. A SOAP interface will also be used.
  }
  ...
  \item \textbf{•Pdf}
\end{itemize}
\paragraph{SOAP interface is what this system is mainly going to focus on - It is a protocol to send markup(structured) information of web services, the system will work with CSV files.}
  % 5
